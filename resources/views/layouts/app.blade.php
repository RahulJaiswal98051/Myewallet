...
<body>
                        ...
                        <div class="header-main-one-wrapper">
                            <div class="thumbnail">
                                <a href="{{ route('welcome') }}">
                                    <img src="assets/images/logo/logo.jpg" alt="Myewallet-logo"
                            ...
                            <div class="main-header">
                                    ...
                                    <ul class="">
                                        ...
                                        <li class="main-nav has-dropdown project-a-after">
                                            ...
                                            <ul class="submenu parent-nav">
                                                <li><a href="{{ route('business-accounts') }}">Business Accounts</a>
                                                </li>
                                                ...
                                                <li><a href="{{ route('myewallet-crypto-card') }}">MYeWallet Crypto
                                                        Card</a></li>
                                        ...
                                        <li class="main-nav has-dropdown project-a-after">
                                            ...
                                            <ul class="submenu parent-nav">
                                                ...
                                                <li><a href="{{ route('supported-countries') }}">Supported Countries</a>
                                                </li>
                                ...
                                <div class="button-area">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="rts-btn btn-primary ml--20 ml_sm--5 header-one-btn quote-btn">Register
                                    </a>
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="footer-one-single-wized mid-bg">
                        ...
                        <div class="app-download-inner">
                            <p class="disc mb--20">Get the MyEwallet app for secure, instant global payments on the go.
                            </p>
                    ...
                    <div class="footer-one-single-wized">
                        ...
                        <div class="quick-link-inner">
                            <ul class="links">
                                ...
                                <li><a href="{{ route('business-accounts') }}"><i class="far fa-arrow-right"></i>
                                        Business Accounts</a></li>
                                <li><a href="{{ route('card-issuing') }}"><i class="far fa-arrow-right"></i> Card
                                        Issuing</a></li>
                                <li><a href="{{ route('cryptoconnect') }}"><i class="far fa-arrow-right"></i>
                                        CryptoConnect</a></li>
                                <li><a href="{{ route('contact') }}"><i class="far fa-arrow-right"></i> Contact Us</a>
                                </li>
                            </ul>
                            <ul class="links margin-left-70">
                                <li><a href="{{ route('app-features') }}"><i class="far fa-arrow-right"></i> App
                                        Features</a></li>
                                <li><a href="{{ route('complaince') }}"><i class="far fa-arrow-right"></i>
                                        Compliance</a></li>
                                <li><a href="{{ route('security') }}"><i class="far fa-arrow-right"></i> Security</a>
                                </li>
                                <li><a href="{{ route('supported-countries') }}"><i class="far fa-arrow-right"></i>
    ...
    <div id="side-bar" class="side-bar header-two">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="index.html"><img class="logo" src="assets/images/logo/logo.jpg"
                    alt="Myewallet-logo"></a>
